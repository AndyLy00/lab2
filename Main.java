...
public class Main {
    public static void main(String[] args) {
        ...
        List<Aditional> aditionalList = new ArrayList<>(List.of(new Aditional("Gaming", "ASUS", "ROG G17", "RGB", "Black"), new Aditional("Personal", "Lenovo", "Legion 5", "LED White", "White"), new Aditional("Business", "Acer", "Predator Helios 300", "RGB", "Gray")));
        ...
        List<Processor> processorList = new ArrayList<>(List.of(new Processor("3.30-4.90", 8, 4, "Zen 3+", "Ryzen 9", "6900HX", "AMD"), new Processor("2.50-4.50", 4, 8, "Comet Lake", "Core i5", "10300H", "Intel"), new Processor("2.10-4.00", 6, 8, "Zen 2+", "Ryzen 5", "2300HX", "AMD")));
        ...
        List<VideoCard> videoCardList = new ArrayList<>(List.of(new VideoCard(4, "Discrete", "GeForce RTX 3050", "NVIDIA"), new VideoCard(6, "Dicrete", "GeForce RTX 3060", "NVIDIA"), new VideoCard(4, "Integrate", "ARC 3", "INTEL")));

        Random random = new Random();

        Computer computer = new Computer(aditionalList.get(random.nextInt(aditionalList.size())), batteryList.get(random.nextInt(batteryList.size())), caseList.get(random.nextInt(caseList.size())), memoryList.get(random.nextInt(memoryList.size())),
